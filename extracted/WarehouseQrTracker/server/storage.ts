...
export class MemStorage implements IStorage {
  ...
  private initializeAdminUsers() {
    ...
    this.users.set(this.userIdCounter++, {
      id: 1,
      username: "admin",
      password: "$2a$10$X7szLJYuM1zhkVXgJzBZm.tOlTzOJ/kCjcXJYn3MCE/GQkG00fX..", // password = "admin123"
      name: "Admin",
      surname: "User",
  ...
  private initializeInventory() {
    const inventoryData = [
      { name: "Guanti monouso (M)", quantity: 125, minimumQuantity: 50, expiryDate: "12/2024", status: "Disponibile" },
      { name: "Disinfettante", quantity: 8, minimumQuantity: 5, expiryDate: "05/2024", status: "Disponibile" },
      { name: "Bombole Ossigeno", quantity: 3, minimumQuantity: 2, expiryDate: "", status: "Bassa Scorta" },
      { name: "Elettrodi DAE", quantity: 5, minimumQuantity: 3, expiryDate: "01/2024", status: "In Scadenza" }
    ];
